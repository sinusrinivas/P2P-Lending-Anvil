...
class RowTemplate40(RowTemplate40Template):
  ...
  def link_2_click(self, **event_args):
    ...
    open_form("lendor_registration_form.dashboard.veiw_loan_extension_requests.extension_details", selected_row=selected_row)
    if selected_row['status'] == 'approved' or selected_row['status'] == 'rejected':
        open_form("lendor_registration_form.dashboard.veiw_loan_extension_requests.extension_details_approved_or_rejected", selected_row=selected_row)
    else:
