...
from ._anvil_designer import payment_details_view_loan_requestTemplate
class payment_details_view_loan_request(payment_details_view_loan_requestTemplate):
