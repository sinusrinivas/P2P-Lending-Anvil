from ._anvil_designer import ItemTemplate51Template
from anvil import *
import anvil.server
...
class ItemTemplate51(ItemTemplate51Template):
  def __init__(self, **properties):
    self.init_components(**properties)
    self.user_id = main_form_module.userId
    user_data = app_tables.fin_loan_details.search(loan_updated_status=q.like('under process%'))
