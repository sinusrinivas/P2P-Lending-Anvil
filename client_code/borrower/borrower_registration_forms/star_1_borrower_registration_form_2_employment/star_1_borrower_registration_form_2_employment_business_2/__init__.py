...
class star_1_borrower_registration_form_2_employment_business_2(star_1_borrower_registration_form_2_employment_business_2Template):
    ...
    def button_2_click(self, **event_args):
        ...
        turn_over = self.text_box_2.text.strip()  # Remove leading and trailing spaces
        ...
        if ' ' in turn_over:
            alert("Spaces are not allowed in the 'Six Month Turnover' input.", title="Invalid Input")
            return
