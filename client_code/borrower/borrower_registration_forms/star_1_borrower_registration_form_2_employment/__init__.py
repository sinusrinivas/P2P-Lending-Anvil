...
# when i select the value student its enabling grid panel_2 inside this i have 2 text boxes,1 file upload 1 image and 1 text area if i press next button it should store  it should store fin_user_profile table 