...
class star_1_borrower_registration_form_2_employment(star_1_borrower_registration_form_2_employmentTemplate):
    ...
    def borrower_college_proof_img_change(self, file, **event_args):
        ...
        if file:
            ...
            if content_type in ['image/jpeg', 'image/png', 'image/jpg']:
                ...
                self.image_1_copy_2.source = '_/theme/bank_users/default%20pdf.png'
            else:
    ...
    def file_loader_2_change(self, file, **event_args):
        """This method is called when a new file is loaded into this FileLoader"""
        if file:
            self.label_10.text = file.name if file else ''
            content_type = file.content_type
    ...
    def button_1_click(self, **event_args):
      """This method is called when the button is clicked"""
      open_form('borrower.borrower_registration_forms.borrower_registration_form_1_education',user_id = self.user_id)
