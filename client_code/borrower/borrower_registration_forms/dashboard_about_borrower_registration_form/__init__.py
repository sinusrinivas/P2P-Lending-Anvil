from ._anvil_designer import dashboard_about_borrower_registration_formTemplate
from anvil import *
import anvil.server
...
class dashboard_about_borrower_registration_form(dashboard_about_borrower_registration_formTemplate):
  ...
  def about_main_form_link_click(self, **event_args):
    """This method is called when the link is clicked"""
    open_form('borrower_registration_form.dashboard.borrower_dashboard_about')
  ...
  def contact_main_form_link_click(self, **event_args):
    """This method is called when the link is clicked"""
    open_form("borrower_registration_form.dashboard.borrower_dashboard_contact")
