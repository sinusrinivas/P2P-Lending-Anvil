from ._anvil_designer import dashboard1Template
from anvil import *
import anvil.server
import anvil.users
...
class dashboard1(dashboard1Template):
...
#         borrower = app_tables.fin_borrower.get(customer_id=self.user_Id)
#         if borrower:
#             self.label_7.text = borrower['borrower_since']
#             self.label_5.text = borrower['credit_limit']
        
#         # Initial state setup
#         self.panel_visible = True  # Assuming the panel is initially visible
#         self.update_panel_alignment()
    
#     def toggle_panel_visibility(self):
#         # Toggle the visibility of content_panel_copy_3
#         self.panel_visible = not self.panel_visible
#         self.content_panel_copy_3.visible = self.panel_visible
#         self.update_panel_alignment()
    
#     def update_panel_alignment(self):
#         # Update alignment based on the visibility of content_panel_copy_3
#         if self.panel_visible:
#             self.content_panel_copy_3.role = 'align-center'
#         else:
#             self.content_panel_copy_3.role = 'align-left'
