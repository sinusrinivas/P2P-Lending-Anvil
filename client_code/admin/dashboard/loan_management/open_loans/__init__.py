  ...
  def __init__(self, **properties):
    ...
    if a == -1:
      ...
      for i in self.list_4:
        b+=1
        if i == "Approved" or i == 'approved' or i == "Close" or i == 'close' or i == "Closed Loans" or i == 'closed loans' or i == 'closed loan' or i == 'closed loan' or i == 'Closed Loan' or i == 'Disbursed loan' or i == 'disbursed loan' or i == "Under Process" or i == "under process" or i == 'underprocess' or i == 'Under process':
          self.index.append(b)
