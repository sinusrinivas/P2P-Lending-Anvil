from ._anvil_designer import closed_loansTemplate
from anvil import *
import anvil.server
...
class closed_loans(closed_loansTemplate):
  def __init__(self, **properties):
    ...
    if a == -1:
      ...
      for i in self.list_4:
        b+=1
        if i == "Close" or i == 'close' or i == "Closed Loans" or i == 'closed loans' or i == 'closed loan' or i == 'closed loan' or i == 'Closed Loan':
          self.index.append(b)
