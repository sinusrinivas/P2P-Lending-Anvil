...
class defaulters(defaultersTemplate):
    ...
    def defaulters_data(self):
        ...
        emi_details = app_tables.fin_emi_table.search(default_fee=q.greater_than_or_equal_to(2))
        ...
        for emi in emi_details:
            loan_id = emi['loan_id']
            if loan_emi_count[loan_id] >= 2:  # Check if the number of EMIs for this loan is >= 2
