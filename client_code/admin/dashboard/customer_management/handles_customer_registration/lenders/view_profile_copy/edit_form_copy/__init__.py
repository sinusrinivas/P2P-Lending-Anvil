...
class edit_form_copy(edit_form_copyTemplate):
    def __init__(self, get_customer_id_value, **properties):
        ...
        self.how_long_types = tables.app_tables.fin_duration_at_address.search()
        self.salary_type = tables.app_tables.fin_lendor_salary_type.search()
        ...
        self.drop_down_3.items = [(st['lendor_salary_type'], st['lendor_salary_type']) for st in self.salary_type]
        ...
        self.drop_down_10.items = [(dt['duration_at_address'], dt['duration_at_address']) for dt in self.how_long_types]
    ...
    def populate_form(self, c):
        ...
        self.set_textbox_visibility(self.text_box_4, self.label_7, self.dob_list[c])
        self.set_textbox_visibility(self.text_box_41,self.label_60,self.email_user_list[c])
        self.set_textbox_visibility(self.text_box_11,self.label_61,self.address_list[c])
        self.set_textbox_visibility(self.text_box_14,self.label_17, self.address2_list[c])
        ...
        self.drop_down_3.selected_value = self.salary_type_list[c]
        ...
        self.set_textbox_visibility(self.text_box_16, self.label_44, self.running_home_loan[c])
        self.set_textbox_visibility(self.text_box_25, self.label_45, self.other_loan[c])
        self.set_textbox_visibility(self.text_box_32, self.label_46, self.personal_loan[c])
        self.set_textbox_visibility(self.text_box_40, self.label_47, self.vehicle_loan[c])
    ...
    def button_2_click(self, **event_args):
            date_of_birth = self.text_box_4.text
        ...
        # Calculate age based on the new date of birth
            ...
            if record:
                record.update(
                    ...
                    street_address_2 = self.text_box_14.text,
                    ...
                    duration_at_address = self.drop_down_10.selected_value,
                    ...
                    salary_type = self.drop_down_3.selected_value,
                    ...
                    home_loan = self.text_box_16.text,
                    other_loan = self.text_box_25.text,
                    credit_card_loans = self.text_box_32.text,
                    vehicle_loan = self.text_box_40.text
                )
            else:
