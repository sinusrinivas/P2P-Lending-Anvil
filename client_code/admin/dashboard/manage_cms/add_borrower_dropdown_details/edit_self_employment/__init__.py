from ._anvil_designer import edit_self_employmentTemplate
from anvil import *
...
class edit_self_employment(edit_self_employmentTemplate):
  def __init__(self,selected_row, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)
    self.text_box_1.text = selected_row['self_employment']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['self_employment'] = update
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
            ...
            name = self.selected_row['self_employment']
