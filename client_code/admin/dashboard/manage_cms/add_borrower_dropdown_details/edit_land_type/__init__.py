from ._anvil_designer import edit_land_typeTemplate
from anvil import *
import anvil.server
...
class edit_land_type(edit_land_typeTemplate):
  def __init__(self,selected_row, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)
    self.text_box_1.text = selected_row['land_type']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['land_type'] = update
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
      ...
      name = self.selected_row['land_type']
