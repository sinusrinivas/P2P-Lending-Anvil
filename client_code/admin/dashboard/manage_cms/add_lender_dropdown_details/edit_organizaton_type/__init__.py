...
class edit_organizaton_type(edit_organizaton_typeTemplate):
  def __init__(self,selected_row, **properties):
    ...
    self.text_box_1.text = selected_row['lendor_organization_type']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['lendor_organization_type'] = update
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
            ...
            name = self.selected_row['lendor_organization_type']
