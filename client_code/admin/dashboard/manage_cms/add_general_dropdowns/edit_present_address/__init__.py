from ._anvil_designer import edit_present_addressTemplate
from anvil import *
import anvil.server
...
class edit_present_address(edit_present_addressTemplate):
  def __init__(self,selected_row, **properties):
    # Set Form properties and Data Bindings.
    self.init_components(**properties)

    # Any code you write here will run before the form opens.
    self.text_box_1.text = selected_row['present_address']
  ...
  def button_1_click(self, **event_args):
    ...
    self.selected_row['present_address'] = updated_gender
  ...
  def delete_button(self, **event_args):
    ...
    if confirmation:
            ...
            group_name = self.selected_row['present_address']
