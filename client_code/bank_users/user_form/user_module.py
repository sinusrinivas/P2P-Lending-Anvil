...
def add_email_and_user_id(email_id):
    ...
    app_tables.fin_beseem_score.add_row(borrower_customer_id=generated_id,borrower_email_id=email_id,documentation_point=0,educational_point=0,language_point=0,loan_point=0,occupation_point=0,region_point=0,relationship_point=0,total_point=50)
