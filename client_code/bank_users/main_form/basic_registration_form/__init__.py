...
class basic_registration_form(basic_registration_formTemplate):
    ...
    def validate_dob(self, **event_args):
        ...
        if dob and datetime.strptime(dob, '%Y-%m-%d').date() <= datetime.now().date():
            ...
            self.date_picker_1.role = 'outlined-error'  # Red role for invalid input
    ...
    def validate_mobile_no(self, **event_args):
        ...
        if re.match(r'^\d{10}$', mobile_no):
            ...
            self.mobile_number_box.role = 'outlined-error'  # Red role for invalid input
    ...
    #             self.alternate_email_text_box.role = None  # Reset role for valid input
    #         else:
    #             self.alternate_email_text_box.role = 'outlined-error'  # Red role for invalid input
    #     else:
    #         self.alternate_email_text_box.role = None  # Reset role if the field is empty
    ...
    def validate_city(self, **event_args):
        ...
        if re.match(r'^[A-Za-z]+$', city):
            ...
            self.text_box_3.role = 'outlined-error'  # Red role for invalid input
    ...
    def validate_state(self, **event_args):
        ...
        if re.match(r'^[A-Za-z]+$', state):
            ...
            self.text_box_5.role = 'outlined-error'  # Red role for invalid input
    ...
    def validate_country(self, **event_args):
        ...
        if re.match(r'^[A-Za-z]+$', country):
            ...
            self.text_box_6.role = 'outlined-error' # Red role for invalid 
    ...
    def submit_btn_click(self, **event_args):
        ...
        # Clear previous error roles
        self.full_name_text_box.role = 'outlined'
        self.date_picker_1.role = 'outlined'
        self.mobile_number_box.role = 'outlined'
        self.alternate_email_text_box.role = 'outlined'
        self.text_box_3.role = 'outlined'
        self.text_box_5.role = 'outlined'
        self.text_box_6.role = 'outlined'
        ...
        if not re.match(r'^[A-Za-z]+$', country):
            ...
            self.text_box_6.role = '#FF0000 '  # Highlight input field with red role
            self.text_box_6.focus()
            return
        ...
        if not re.match(r'^[A-Za-z]+$', city):
            ...
            self.text_box_3.role = '#FF0000 '
            self.text_box_3.focus()
            return
    
        # Validate full name
        if not re.match(r'^[A-Za-z\s]+$', full_name):
            self.full_name_text_box.role = '#FF0000 '
            self.full_name_text_box.focus()
            return
        ...
        if not dob or datetime.strptime(dob, '%Y-%m-%d').date() > datetime.now().date():
            ...
            self.date_picker_1.role = '#FF0000 '
            self.date_picker_1.focus()
            return
        ...
        if not re.match(r'^\d{10}$', mobile_no):
            ...
            self.mobile_number_box.role = '#FF0000 '
            self.mobile_number_box.focus()
            return
        ...
        if user_data and alternate_email == user_data['email_user']:
            ...
            self.alternate_email_text_box.role = '#ffb3b3'
