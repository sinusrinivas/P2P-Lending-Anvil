from ._anvil_designer import lender_registration_education_IntermediateTemplate
from anvil import *
import anvil.server
...
class lender_registration_education_Intermediate(lender_registration_education_IntermediateTemplate):
