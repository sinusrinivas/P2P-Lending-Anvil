...
#         email = self.email
#         # self.load_data()  # Initial loading of data without any parameter

#     def load_data(self, status=None):
#         # If status is None, perform the initial loading without filtering by status
#         # If status is provided, filter the loan_updated_status by that status
#         if status is None:
#             underprocess_loans = app_tables.fin_loan_details.search(
...
#         else:
#             underprocess_loans = app_tables.fin_loan_details.search(
#                 loan_updated_status=q.like(status),
#                 lender_customer_id=self.user_id
#             )
        
#         # Assign the filtered data to the repeating panels based on the status
...
#         # Call load_data() with 'under process' as the status parameter
#         self.load_data('under process')

#     def button_2_copy_click(self, **event_args):
#         # Call load_data() with 'disbursed loan' as the status parameter
#         self.load_data('disbursed loan')

#     def button_3_copy_click(self, **event_args):
#         # Call load_data() with 'lost opportunities' as the status parameter
#         self.load_data('lost opportunities')

#     def button_4_copy_click(self, **event_args):
#         # Call load_data() with 'close' as the status parameter
#         self.load_data('close')

#     def button_5_copy_click(self, **event_args):
#         # Call load_data() with 'extension' as the status parameter
