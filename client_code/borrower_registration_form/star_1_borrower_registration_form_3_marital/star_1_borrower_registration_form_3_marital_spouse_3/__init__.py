from ._anvil_designer import star_1_borrower_registration_form_3_marital_spouse_3Template
from anvil import *
import anvil.server
...
class star_1_borrower_registration_form_3_marital_spouse_3(star_1_borrower_registration_form_3_marital_spouse_3Template):
  ...
  def button_1_click(self, **event_args):
    open_form('borrower_registration_form.star_1_borrower_registration_form_3_marital.star_1_borrower_registration_form_3_marital_spouse_2',user_id =self.user_id)
  ...
  def button_2_click(self, **event_args):
    ...
    open_form('borrower_registration_form.star_1_borrower_registration_form_4_loan',user_id =self.user_id)
