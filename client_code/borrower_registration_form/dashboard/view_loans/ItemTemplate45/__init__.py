from ._anvil_designer import ItemTemplate45Template
from anvil import *
import anvil.server
...
class ItemTemplate45(ItemTemplate45Template):
  def __init__(self, **properties):
    self.init_components(**properties)
    self.user_id = main_form_module.userId   
    user_data = app_tables.fin_loan_details.search(loan_updated_status=q.like('foreclosure%'), borrower_customer_id=self.user_id)
