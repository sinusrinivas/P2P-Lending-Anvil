from ._anvil_designer import ItemTemplate44Template
from anvil import *
import anvil.server
...
class ItemTemplate44(ItemTemplate44Template):
  def __init__(self, **properties):
    self.init_components(**properties)
    self.user_id = main_form_module.userId   
    user_data = app_tables.fin_loan_details.search(loan_updated_status=q.like('under process%'), borrower_customer_id=self.user_id)
