...
class check(checkTemplate):
    ...
    # def display_three_month_payment_details(self):
    #     monthly_interest_rate = float(int(self.interest_rate) / 100) / 12
    #     emi_denominator = ((1 + monthly_interest_rate) ** self.tenure_months) - 1
    #     emi_numerator = self.loan_amount * monthly_interest_rate * ((1 + monthly_interest_rate) ** self.tenure_months)
    #     emi = emi_numerator / emi_denominator
    
    #     payment_schedule = self.calculate_three_month_payment_schedule(emi, monthly_interest_rate)
    #     self.repeating_panel_1.items = payment_schedule
    # def calculate_total_interest_for_three_months(self, emi, monthly_interest_rate, start_month, end_month):
    #     total_interest = 0
    
    #     for month in range(start_month, end_month + 1):
    #         interest_amount = self.loan_amount_beginning_balance * monthly_interest_rate
    #         total_interest += interest_amount
    #         self.loan_amount_beginning_balance -= emi - interest_amount  # Update for the next month
    
    #     return total_interest

    # def calculate_three_month_payment_schedule(self, emi, monthly_interest_rate):
    # payment_schedule = []
    ...
    #     total_interest = self.calculate_total_interest_for_three_months(
    #         emi, monthly_interest_rate, max(1, month - 2), month)
    #     total_processing_fee = processing_fee_per_month * min(3, self.tenure_months - month + 1)
    #     total_principal = emi * min(3, self.tenure_months - month + 1) - total_interest

    #     total_payment = emi * min(3, self.tenure_months - month + 1) + total_interest + total_processing_fee

    #     ending_balance = beginning_balance - total_payment
    #     loan_amount_ending_balance = loan_amount_beginning_balance - total_principal
    ...
    #             'PaymentDate': "Awaiting update",
    #             'BeginningBalance': f"₹ {beginning_balance:.2f}",
    #             'ScheduledPayment': f"₹ {total_payment:.2f}",
    #             'ExtraPayment': "₹ 0.00",
    #             'TotalPayment': f"₹ {total_payment:.2f}",
    #             'Interest': f"₹ {total_interest:.2f}",
    #             'Principal': f"₹ {total_principal:.2f}",
    ...
    # #         total_interest += interest_amount
    # #         total_payment = emi + processing_fee_per_month + interest_amount
    # #         ending_balance = beginning_balance - total_payment
    ...
    # #                 'BeginningBalance': f"₹ {beginning_balance:.2f}",
    # #                 'ScheduledPayment': f"₹ {emi:.2f}",
    # #                 'ExtraPayment': f"₹ {processing_fee_per_month:.2f}",
    # #                 'TotalPayment': f"₹ {total_payment:.2f}",
    # #                 'Interest': f"₹ {total_interest:.2f}",
    # #                 'Principal': f"₹ {principal_amount:.2f}",
    # #                 'ProcessingFee': f"₹ {processing_fee_per_month:.2f}",
    ...
    # #             # Reset values for the next three-month period
    # #             total_interest = 0
    # #             beginning_balance = ending_balance
    # #             loan_amount_beginning_balance = loan_amount_ending_balance
    # #         else:
    ...
    # def display_six_month_payment_details(self):
    #     monthly_interest_rate = float(int(self.interest_rate) / 100) / 12
    #     emi_denominator = ((1 + monthly_interest_rate) ** self.tenure_months) - 1
    #     emi_numerator = self.loan_amount * monthly_interest_rate * ((1 + monthly_interest_rate) ** self.tenure_months)
    #     emi = emi_numerator / emi_denominator

    #     payment_schedule = self.calculate_six_month_payment_schedule(emi, monthly_interest_rate)
    #     self.repeating_panel_1.items = payment_schedule

    # def calculate_total_interest_for_six_months(self, emi, monthly_interest_rate, start_month, end_month):
    #     total_interest = 0
    ...
    # def calculate_six_month_payment_schedule(self, emi, monthly_interest_rate):
    #     payment_schedule = []
    #     beginning_balance = self.total_repayment_amount  
    #     loan_amount_beginning_balance = self.loan_amount
    #     processing_fee_per_month = (self.processing_fee / 100) * self.loan_amount / self.tenure_months
    ...
    #     for month in range(1, self.tenure_months + 1):
    #         interest_amount = loan_amount_beginning_balance * monthly_interest_rate
    #         principal_amount = emi - interest_amount  # Principal for the current month
    #         loan_amount_ending_balance = loan_amount_beginning_balance - principal_amount
    
    #         if month % 6 == 0:  # Change to check every six months
    #             total_interest = self.calculate_total_interest_for_six_months(
    #                 emi, monthly_interest_rate, month - 5, month)  # Calculate total interest for the next six months
    #             total_processing_fee = processing_fee_per_month * 6
    #             total_principal = (emi * 6) - total_interest
    #             total_payment = (emi * 6) + total_interest + total_processing_fee
    #             ending_balance = beginning_balance - total_payment
    ...
    #             beginning_balance = ending_balance
    #             loan_amount_beginning_balance = loan_amount_ending_balance  # Update for the next iteration
