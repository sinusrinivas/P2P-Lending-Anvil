...
#                 principal_amount = min(last_paid_emi_ending_balance, emi - interest_amount)  # Adjust principal amount to avoid negative balance
#                 ending_balance = max(0, last_paid_emi_ending_balance - principal_amount)  # Ensure ending balance is non-negative
