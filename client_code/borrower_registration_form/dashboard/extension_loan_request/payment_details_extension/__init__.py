...
#                 principal_amount = min(last_paid_emi_ending_balance, emi - interest_amount)  # Ensure principal doesn't exceed balance
#                 ending_balance = max(0, last_paid_emi_ending_balance - principal_amount)  # Ensure non-negative balance
