from ._anvil_designer import star_1_borrower_registration_form_educationTemplate
from anvil import *
import anvil.server
...
class star_1_borrower_registration_form_education(star_1_borrower_registration_form_educationTemplate):
